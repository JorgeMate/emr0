...
class StatsController extends AbstractController
{
  ...
  /**
     * @Route("/{slug}/treatments", methods={"GET"}, name="stats_treatments")
     * @param EntityManagerInterface $em
     * @return Response
     */
    public function statsTreatments(EntityManagerInterface $em)
    {
        $from = '01/01/' . date('Y');
        $to = date('d/m/Y');
        ...
        return $this->render('/stats/treatments.html.twig', [
    ...
    public function queryTreatmentDetails(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('/stats/treatment_details.html.twig', [
